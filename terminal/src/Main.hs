  ...
  let
    ...
    makeFlags =
      flags Make.Flags
        ...
        |-- onOff "simplify" "Turn on extra optimizations"
        |-- flag "simplify-limit" Make.simplifyLimit "Limit the number of passes of extra optimizations"
        |-- flag "dump" Make.dump "Dump internal information about the AST during simplification"
