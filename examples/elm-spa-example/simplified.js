			...
			A3(
				...
				A3(
					...
					A3(
						$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
						'id',
						A2($elm$json$Json$Decode$map, $elm$core$Basics$identity, _Json_decodeInt),
			...
			A3(
				...
				A3(
					...
					A3(
						$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
						'tagList',
						$elm$json$Json$Decode$list(_Json_decodeString),
						A3(
							$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
							'title',
							_Json_decodeString,
...
var $author$project$Article$fullDecoder = function (maybeCred) {
	return A3(
		$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'body',
		A2(_Json_map1, $elm$core$Basics$identity, $author$project$Article$Body$decoder),
		A2(
			$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$custom,
...
var $author$project$Article$Tag$list = A3(
	...
	A2(
		$elm$json$Json$Decode$field,
		'tags',
		_Json_decodeList($author$project$Article$Tag$decoder)));
...
var $author$project$Article$Body$toHtml = F2(
	function (_v0, attributes) {
		var markdown = _v0;
		return A2(
			_Markdown_toHtml($elm_explorations$markdown$Markdown$defaultOptions),
			attributes,
			markdown);
	});
