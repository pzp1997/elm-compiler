	...
	return A3(
		...
		F3(
			function (key, value, keyList) {
				return A2(_List_cons, key, keyList);
			}),
		_List_Nil,
		dict);
};
	...
	function (func, baseCase, _v0) {
		...
		var helper = F2(
			function (node, acc) {
				if (!node.$) {
					var subTree = node.a;
					return A3(_JsArray_foldr, helper, acc, subTree);
				} else {
					var values = node.a;
					return A3(_JsArray_foldr, func, acc, values);
				}
			});
		return A3(
			_JsArray_foldr,
			helper,
			A3(_JsArray_foldr, func, baseCase, tail),
			tree);
	});
var $elm$core$Array$toList = function (array) {
	return A3($elm$core$Array$foldr, _List_cons, _List_Nil, array);
};
...
var $elm$core$List$reverse = function (list) {
	return A3($elm$core$List$foldl, _List_cons, _List_Nil, list);
};
...
var $elm$core$Array$shiftStep = _Basics_ceiling(
	A2($elm$core$Basics$logBase, 2, 32));
var $elm$core$Array$empty = A4($elm$core$Array$Array_elm_builtin, 0, $elm$core$Array$shiftStep, _JsArray_empty, _JsArray_empty);
	...
	function (reverseNodeList, builder) {
		if (!builder.f) {
			return A4(
				...
				_JsArray_length(builder.h),
				$elm$core$Array$shiftStep,
				_JsArray_empty,
				builder.h);
		} else {
			var treeLen = builder.f * 32;
			var depth = _Basics_floor(
				A2($elm$core$Basics$logBase, 32, treeLen - 1));
			var correctNodeList = reverseNodeList ? $elm$core$List$reverse(builder.i) : builder.i;
			var tree = A2($elm$core$Array$treeFromBuilder, correctNodeList, builder.f);
			return A4(
				$elm$core$Array$Array_elm_builtin,
				_JsArray_length(builder.h) + treeLen,
...
var $elm$core$Array$initialize = F2(
	function (len, fn) {
		if (len <= 0) {
			...
			var tailLen = len % 32;
			var tail = A3(_JsArray_initialize, tailLen, len - tailLen, fn);
...
var $elm$core$String$left = F2(
	function (n, string) {
		return (n < 1) ? '' : A3(_String_slice, 0, n, string);
	});
var $elm$core$String$toInt = _String_toInt;
var $elm$url$Url$chompBeforePath = F5(
	function (protocol, path, params, frag, str) {
		if ($elm$core$String$isEmpty(str) || A2(_String_contains, '@', str)) {
			return $elm$core$Maybe$Nothing;
		} else {
			var _v0 = A2(_String_indexes, ':', str);
			if (!_v0.b) {
...
var $elm$url$Url$fromString = function (str) {
	return A2(_String_startsWith, 'http://', str) ? A2(
		F2(
			function (protocol, str) {
				if ($elm$core$String$isEmpty(str)) {
					return $elm$core$Maybe$Nothing;
		...
		0,
		A2($elm$core$String$dropLeft, 7, str)) : (A2(_String_startsWith, 'https://', str) ? A2(
		F2(
			function (protocol, str) {
				if ($elm$core$String$isEmpty(str)) {
					return $elm$core$Maybe$Nothing;
...
var $elm$core$Task$init = _Scheduler_succeed(0);
...
var $author$project$Username$decoder = A2(_Json_map1, $elm$core$Basics$identity, _Json_decodeString);
var $NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$custom = _Json_map2($elm$core$Basics$apR);
var $elm$json$Json$Decode$field = _Json_decodeField;
var $NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required = F3(
	function (key, valDecoder, decoder) {
		return A2(
			$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$custom,
			A2(_Json_decodeField, key, valDecoder),
			decoder);
	});
var $author$project$Api$credDecoder = A3(
	...
	A3(
		...
		_Json_succeed($author$project$Api$Cred)));
			...
			function (flags, url, navKey) {
				var maybeViewer = $elm$core$Result$toMaybe(
					A2(
						...
						A2(_Json_run, _Json_decodeString, flags)));
...
var $elm$json$Json$Decode$nullable = function (decoder) {
	return _Json_oneOf(
		_List_fromArray(
			[
				_Json_decodeNull($elm$core$Maybe$Nothing),
				A2(_Json_map1, $elm$core$Maybe$Just, decoder)
			]));
};
var $author$project$Avatar$decoder = A2(
	_Json_map1,
	$elm$core$Basics$identity,
	$elm$json$Json$Decode$nullable(_Json_decodeString));
var $author$project$Viewer$decoder = A2(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$custom,
	A2(_Json_decodeField, 'image', $author$project$Avatar$decoder),
	_Json_succeed($author$project$Viewer$Viewer));
...
var $author$project$Article$Body$decoder = A2(_Json_map1, $elm$core$Basics$identity, _Json_decodeString);
...
var $author$project$Article$Slug$decoder = A2(_Json_map1, $elm$core$Basics$identity, _Json_decodeString);
		...
		var nullOr = function (decoder) {
			return _Json_oneOf(
				_List_fromArray(
					[
						decoder,
						_Json_decodeNull(fallback)
					]));
		};
		var handleResult = function (input) {
			var _v0 = A2(_Json_run, pathDecoder, input);
			if (!_v0.$) {
				var rawValue = _v0.a;
				var _v1 = A2(
					_Json_run,
				...
				if (!_v1.$) {
					...
					return _Json_succeed(finalResult);
				} else {
					var finalErr = _v1.a;
					return _Json_fail(
				...
				return _Json_succeed(fallback);
			}
		};
		return A2(_Json_andThen, handleResult, _Json_decodeValue);
	});
	...
	function (key, valDecoder, fallback, decoder) {
		return A2(
			...
			A3(
				...
				A2(_Json_decodeField, key, _Json_decodeValue),
				valDecoder,
				fallback),
			decoder);
	});
...
var $author$project$Author$decodeFromPair = F2(
	function (maybeCred, _v0) {
		...
		if (maybeCred.$ === 1) {
			...
			return _Utils_eq(
				uname,
				$author$project$Api$username(cred)) ? _Json_succeed(
				A2($author$project$Author$IsViewer, cred, prof)) : A2(
				F2(
					function (prof, uname) {
						return A4(
	...
	return A2(
		...
		A3(
			...
			A2(
				...
				_Json_succeed($elm$core$Tuple$pair))));
};
...
var $elm$parser$Parser$end = function (x) {
	return function (s) {
		return _Utils_eq(
...
var $rtfeldman$elm_iso8601_date_strings$Iso8601$fromParts = F6(
	function (monthYearDayMs, hour, minute, second, ms, utcOffsetMinutes) {
		return (((monthYearDayMs + (((hour * 60) * 60) * 1000)) + (((minute - utcOffsetMinutes) * 60) * 1000)) + (second * 1000)) + ms;
	});
...
var $elm$parser$Parser$keeper = F2(
	function (parseFunc, parseArg) {
		return A3($elm$parser$Parser$Advanced$map2, $elm$core$Basics$apL, parseFunc, parseArg);
	});
		...
		return function (s0) {
			...
			if (_v1.$ === 1) {
				...
				return A3(
					...
					A2(
						func,
						A3(_String_slice, s0.b, s1.b, s0.a),
						a),
					s1);
			}
		};
...
var $elm$parser$Parser$getChompedString = function (parser) {
	return A2($elm$parser$Parser$Advanced$mapChompedString, $elm$core$Basics$always, parser);
};
	...
	return A2(
		...
		function (str) {
			if (_Utils_eq(
				_String_length(str),
				quantity)) {
				var _v0 = _String_toInt(str);
				if (!_v0.$) {
					var intVal = _v0.a;
					return $elm$parser$Parser$Advanced$succeed(intVal);
				} else {
					return $elm$parser$Parser$problem('Invalid integer: \"' + (str + '\"'));
				}
			} else {
				return $elm$parser$Parser$problem(
					'Expected ' + (_String_fromNumber(quantity) + (' digits, but got ' + _String_fromNumber(
						_String_length(str)))));
			}
		},
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5(_Parser_isSubString, str, s.b, s.a7, s.aD, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
...
var $rtfeldman$elm_iso8601_date_strings$Iso8601$invalidDay = function (day) {
	return $elm$parser$Parser$problem(
		'Invalid day: ' + _String_fromNumber(day));
};
var $elm$core$Basics$modBy = _Basics_modBy;
var $elm$core$Basics$neq = _Utils_notEqual;
var $rtfeldman$elm_iso8601_date_strings$Iso8601$isLeapYear = function (year) {
	return (!A2(_Basics_modBy, 4, year)) && ((!(!A2(_Basics_modBy, 100, year))) || (!A2(_Basics_modBy, 400, year)));
};
...
var $rtfeldman$elm_iso8601_date_strings$Iso8601$yearMonthDay = function (_v0) {
	...
	if (dayInMonth < 0) {
		...
		var succeedWith = function (extraMs) {
			var yearMs = 31536000000 * (year - 1970);
			var days = ((month < 3) || (!function (year) {
				return (!A2($elm$core$Basics$modBy, 4, year)) && ((!(!A2($elm$core$Basics$modBy, 100, year))) || (!A2($elm$core$Basics$modBy, 400, year)));
			}(year))) ? (dayInMonth - 1) : dayInMonth;
			var dayMs = 86400000 * (days + (function (y1) {
				var y = y1 - 1;
				return (((y / 4) | 0) - ((y / 100) | 0)) + ((y / 400) | 0);
			}(year) - function (y1) {
				var y = y1 - 1;
			...
			return $elm$parser$Parser$Advanced$succeed((extraMs + yearMs) + dayMs);
		};
		switch (month) {
			case 1:
				return (dayInMonth > 31) ? function (day) {
					return $elm$parser$Parser$problem(
						'Invalid day: ' + _String_fromNumber(day));
				}(dayInMonth) : succeedWith(0);
			case 2:
				return ((dayInMonth > 29) || ((dayInMonth === 29) && (!function (year) {
					return (!A2($elm$core$Basics$modBy, 4, year)) && ((!(!A2($elm$core$Basics$modBy, 100, year))) || (!A2($elm$core$Basics$modBy, 400, year)));
				}(year)))) ? function (day) {
					return $elm$parser$Parser$problem(
						'Invalid day: ' + _String_fromNumber(day));
				}(dayInMonth) : succeedWith(2678400000);
			case 3:
				return (dayInMonth > 31) ? function (day) {
					return $elm$parser$Parser$problem(
						'Invalid day: ' + _String_fromNumber(day));
				}(dayInMonth) : succeedWith(5097600000);
			case 4:
				return (dayInMonth > 30) ? function (day) {
					return $elm$parser$Parser$problem(
						'Invalid day: ' + _String_fromNumber(day));
				}(dayInMonth) : succeedWith(7776000000);
			case 5:
				return (dayInMonth > 31) ? function (day) {
					return $elm$parser$Parser$problem(
						'Invalid day: ' + _String_fromNumber(day));
				}(dayInMonth) : succeedWith(10368000000);
			case 6:
				return (dayInMonth > 30) ? function (day) {
					return $elm$parser$Parser$problem(
						'Invalid day: ' + _String_fromNumber(day));
				}(dayInMonth) : succeedWith(13046400000);
			case 7:
				return (dayInMonth > 31) ? function (day) {
					return $elm$parser$Parser$problem(
						'Invalid day: ' + _String_fromNumber(day));
				}(dayInMonth) : succeedWith(15638400000);
			case 8:
				return (dayInMonth > 31) ? function (day) {
					return $elm$parser$Parser$problem(
						'Invalid day: ' + _String_fromNumber(day));
				}(dayInMonth) : succeedWith(18316800000);
			case 9:
				return (dayInMonth > 30) ? function (day) {
					return $elm$parser$Parser$problem(
						'Invalid day: ' + _String_fromNumber(day));
				}(dayInMonth) : succeedWith(20995200000);
			case 10:
				return (dayInMonth > 31) ? function (day) {
					return $elm$parser$Parser$problem(
						'Invalid day: ' + _String_fromNumber(day));
				}(dayInMonth) : succeedWith(23587200000);
			case 11:
				return (dayInMonth > 30) ? function (day) {
					return $elm$parser$Parser$problem(
						'Invalid day: ' + _String_fromNumber(day));
				}(dayInMonth) : succeedWith(26265600000);
			case 12:
				return (dayInMonth > 31) ? function (day) {
					return $elm$parser$Parser$problem(
						'Invalid day: ' + _String_fromNumber(day));
				}(dayInMonth) : succeedWith(28857600000);
			default:
				return $elm$parser$Parser$problem(
					'Invalid month: \"' + (_String_fromNumber(month) + '\"'));
		}
	}
};
	...
	A3(
		...
		A3(
			...
			A3(
				$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
				'tagList',
				_Json_decodeList(_Json_decodeString),
				A3(
					$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
					'title',
					_Json_decodeString,
...
var $author$project$Article$fullDecoder = function (maybeCred) {
	return A3(
		...
		A2(
			...
			_Json_succeed($author$project$Article$Article)));
};
...
var $author$project$Api$credHeader = function (_v0) {
	var str = _v0.b;
	return A2($elm$http$Http$Internal$Header, 'authorization', 'Token ' + str);
};
...
var $elm$http$Http$expectJson = function (decoder) {
	return _Http_expectStringResponse(
		function (response) {
			var _v0 = A2(_Json_runOnString, decoder, response.X);
			if (_v0.$ === 1) {
...
var $author$project$Api$get = F3(
	function (url, maybeCred, decoder) {
		return $author$project$Api$Endpoint$request(
			{
				X: $elm$http$Http$Internal$EmptyBody,
...
var $author$project$CommentId$decoder = A2(_Json_map1, $elm$core$Basics$identity, _Json_decodeInt);
		...
		return $elm$core$Task$command(
			A2(
				...
				A2(
					...
					A2($elm$core$Basics$composeL, _Scheduler_succeed, resultToMessage),
					$elm$core$Result$Err),
				A2(
					_Scheduler_andThen,
					A2(
...
var $author$project$Loading$slowThreshold = _Process_sleep(500);
...
var $author$project$Article$Feed$pageCountDecoder = function (resultsPerPage) {
	return A2(
		_Json_map1,
		function (total) {
			return _Basics_ceiling(total / resultsPerPage);
		},
		_Json_decodeInt);
};
...
var $NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$hardcoded = A2($elm$core$Basics$composeR, _Json_succeed, $NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$custom);
...
var $elm$url$Url$Builder$string = F2(
	function (key, value) {
		return A2(
			...
			_Url_percentEncode(key),
			_Url_percentEncode(value));
	});
var $author$project$PaginatedList$params = function (_v0) {
	...
	return _List_fromArray(
		[
			...
			'limit',
			_String_fromNumber(resultsPerPage)),
			A2(
			$elm$url$Url$Builder$string,
			'offset',
			_String_fromNumber(offset))
		]);
};
...
var $author$project$Page$Home$fetchFeed = F3(
	function (session, feedTabs, page) {
		var params = $author$project$PaginatedList$params(
			{bL: page, bN: 10});
		var maybeCred = $author$project$Session$cred(session);
		var decoder = A2($author$project$Article$Feed$decoder, maybeCred, 10);
				...
				default:
					...
					return A3(
						...
						$author$project$Api$Endpoint$articles(
							A2(_List_cons, firstParam, params)),
						maybeCred,
						decoder);
			}
		}();
...
var $author$project$Article$Tag$decoder = A2(_Json_map1, $elm$core$Basics$identity, _Json_decodeString);
...
var $author$project$Page$Home$init = function (session) {
	var loadTags = $elm$http$Http$toTask(
		A3(
			$author$project$Api$get,
...
var $elm$core$Platform$Cmd$none = _Platform_batch(_List_Nil);
...
var $elm$core$Task$mapError = F2(
	function (convert, task) {
		return A2(
			_Scheduler_onError,
			A2($elm$core$Basics$composeL, _Scheduler_fail, convert),
			task);
	});
	...
	function (session, feedTabs, username, page) {
		...
		var params = A2(
			...
			$author$project$PaginatedList$params(
				{bL: page, bN: 5}));
		var expect = A2($author$project$Article$Feed$decoder, maybeCred, 5);
		return A2(
			$elm$core$Task$attempt,
						...
						A2(
							...
							$elm$http$Http$toTask(
								A2(
									...
									username,
									maybeCred)))),
						A4($author$project$Page$Profile$fetchFeed, session, 0, username, 1),
...
var $elm$url$Url$Parser$addParam = F2(
	function (segment, dict) {
		...
		if ((_v0.b && _v0.b.b) && (!_v0.b.b.b)) {
			...
			var _v1 = _v0.b;
			var rawValue = _v1.a;
			var _v2 = _Url_percentDecode(rawKey);
			if (_v2.$ === 1) {
				return dict;
			} else {
				var key = _v2.a;
				var _v3 = _Url_percentDecode(rawValue);
				if (_v3.$ === 1) {
					return dict;
				} else {
					var value = _v3.a;
...
var $elm$core$List$append = F2(
	function (xs, ys) {
		if (!ys.b) {
			...
			return A3($elm$core$List$foldr, _List_cons, ys, xs);
		}
	});
...
var $author$project$Route$parser = function (parsers) {
	return function (state) {
		return A2(
			$elm$core$List$concatMap,
			function (_v0) {
...
var $author$project$Api$viewerChanges = F2(
	function (toMsg, decoder) {
		return $elm$json$Json$Decode$value(
			function (value) {
				return toMsg(
					A2(
						F2(
...
var $elm$url$Url$addPort = F2(
	function (maybePort, starter) {
		if (maybePort.$ === 1) {
			...
			return starter + (':' + _String_fromNumber(port_));
		}
	});
...
var $author$project$Api$addServerError = function (list) {
	return A2(_List_cons, 'Server error', list);
};
var $author$project$CommentId$toString = function (_v0) {
	var id = _v0;
	return _String_fromNumber(id);
};
	...
	function (articleSlug, commentId, cred) {
		return A4(
			...
			A2(
				...
				commentId),
			cred,
			$elm$http$Http$Internal$EmptyBody,
			_Json_succeed(0));
	});
...
var $elm$core$List$filter = F2(
	function (isGood, list) {
		return A3(
			...
			F2(
				function (x, xs) {
					return isGood(x) ? A2(_List_cons, x, xs) : xs;
				}),
			_List_Nil,
			list);
	});
							...
							_Utils_update(
								model,
								{
									l: $author$project$Page$Article$Loaded(
										_Utils_Tuple2(
											$author$project$Page$Article$Editing(''),
											A2(_List_cons, comment, comments)))
								}),
							$elm$core$Platform$Cmd$none);
					} else {
						return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
...
var $author$project$Page$Article$Editor$trimFields = function (form) {
	return {
		X: _String_trim(form.X),
		bw: _String_trim(form.bw),
		bS: _String_trim(form.bS),
		bT: _String_trim(form.bT)
	};
};
				...
				switch (_v2.$) {
					case 2:
						...
						return _Utils_Tuple2(
							...
							A2(_Platform_map, $author$project$Page$Home$GotFeedMsg, subCmd));
					case 0:
						return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
					case 1:
						return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
...
var $author$project$Avatar$encode = function (_v0) {
	...
	if (!maybeUrl.$) {
		var url = maybeUrl.a;
		return _Json_wrap(url);
	} else {
		return _Json_encodeNull;
	}
};
var $author$project$Username$encode = function (_v0) {
	var username = _v0;
	return _Json_wrap(username);
};
				...
				switch (_v3.$) {
					case 2:
						...
						return _Utils_Tuple2(
							...
							A2(_Platform_map, $author$project$Page$Profile$GotFeedMsg, subCmd));
					case 0:
						return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
					case 1:
						return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
		...
		return A2(
			...
			function () {
				switch (field) {
					...
					default:
						return $elm$core$String$isEmpty(form.A) ? _List_fromArray(
							['password can\'t be blank.']) : ((_String_length(form.A) < 6) ? _List_fromArray(
							[
								'password must be at least ' + (_String_fromNumber(6) + ' characters long.')
							]) : _List_Nil);
				}
			}());
	});
...
var $author$project$Page$Settings$trimFields = function (form) {
	return {
		J: _String_trim(form.J),
		K: _String_trim(form.K),
		x: _String_trim(form.x),
		A: _String_trim(form.A),
		C: _String_trim(form.C)
	};
				...
				switch (field) {
					...
					case 1:
						return $elm$core$String$isEmpty(form.x) ? _List_fromArray(
							['email can\'t be blank.']) : _List_Nil;
					default:
						var passwordLength = _String_length(form.A);
						return ((passwordLength > 0) && (passwordLength < 6)) ? _List_fromArray(
							[
								'password must be at least ' + (_String_fromNumber(6) + ' characters long.')
							]) : _List_Nil;
				}
...
var $elm$html$Html$map = _VirtualDom_map;
...
var $elm$html$Html$text = _VirtualDom_text;
var $author$project$Page$viewFooter = A2(
	_VirtualDom_node('footer'),
	_List_Nil,
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$virtual_dom$VirtualDom$text('conduit')
						])),
					A2(
					$elm$html$Html$span,
					_List_fromArray(
					...
					_List_fromArray(
						[
							$elm$virtual_dom$VirtualDom$text('An interactive learning project from '),
							A2(
							$elm$html$Html$a,
							_List_fromArray(
								[
							...
							_List_fromArray(
								[
									$elm$virtual_dom$VirtualDom$text('Thinkster')
								])),
							$elm$virtual_dom$VirtualDom$text('. Code & design licensed under MIT.')
						]))
				]))
		]));
...
var $author$project$Avatar$src = function (_v0) {
	var maybeUrl = _v0;
	if (maybeUrl.$ === 1) {
		return $author$project$Asset$src(
			$author$project$Asset$image('smiley-cyrus.jpg'));
	} else {
		if (maybeUrl.a === '') {
			return $author$project$Asset$src(
				$author$project$Asset$image('smiley-cyrus.jpg'));
...
var $author$project$Username$toHtml = function (_v0) {
	var username = _v0;
	return $elm$virtual_dom$VirtualDom$text(username);
};
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_Nil),
							$elm$virtual_dom$VirtualDom$text('\u00A0New Post')
						])),
					A2(
					linkTo,
					$author$project$Route$Settings,
					_List_fromArray(
						[
							...
							_List_Nil),
							$elm$virtual_dom$VirtualDom$text('\u00A0Settings')
						])),
					A2(
					linkTo,
					...
					_List_fromArray(
						[
							$elm$virtual_dom$VirtualDom$text('Sign out')
						]))
				]);
		} else {
			return _List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$virtual_dom$VirtualDom$text('Sign in')
						])),
					A2(
					linkTo,
					$author$project$Route$Register,
					_List_fromArray(
						[
							$elm$virtual_dom$VirtualDom$text('Sign up')
						]))
				]);
		}
	});
						...
						[
							...
							A2(
								...
								A3(
									...
									_List_fromArray(
										[
											$elm$virtual_dom$VirtualDom$text('Home')
										])),
								A2(
									F2(
										function (page, maybeViewer) {
...
var $author$project$Loading$error = function (str) {
	return $elm$virtual_dom$VirtualDom$text('Error loading ' + (str + '.'));
};
...
var $author$project$Loading$icon = A2(
	...
	_List_fromArray(
		[
			$author$project$Asset$src(
			$author$project$Asset$image('loading.svg')),
			function (n) {
			return A2(
				_VirtualDom_attribute,
				'width',
			...
			$elm$html$Html$Attributes$stringProperty('alt')('Loading...')
		]),
	_List_Nil);
...
var $elm_explorations$markdown$Markdown$toHtml = _Markdown_toHtml(
	{
		aF: $elm$core$Maybe$Nothing,
		bE: $elm$core$Maybe$Just(
			{bo: false, bR: false}),
...
var $author$project$Article$Body$toHtml = F2(
	function (_v0, attributes) {
		var markdown = _v0;
		return A2(
			$elm_explorations$markdown$Markdown$toHtmlWith($elm_explorations$markdown$Markdown$defaultOptions),
			attributes,
			markdown);
	});
...
var $elm$time$Time$flooredDiv = F2(
	function (numerator, denominator) {
		return _Basics_floor(numerator / denominator);
	});
...
var $elm$html$Html$Attributes$attribute = F2(
	function (key, value) {
		return A2(
			_VirtualDom_attribute,
			_VirtualDom_noOnOrFormAction(key),
...
var $elm$json$Json$Decode$at = F2(
	function (fields, decoder) {
		return A3($elm$core$List$foldr, _Json_decodeField, decoder, fields);
	});
					...
					[
							...
							[
								...
								_List_fromArray(
									[
										...
										A2($elm$virtual_dom$VirtualDom$attribute, 'rows', '3'),
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$virtual_dom$VirtualDom$text('Post Comment')
									]))
							]))
					]));
		} else {
			return A2(
				...
				_List_fromArray(
					[
						...
						$elm$virtual_dom$VirtualDom$text(' or '),
						A2(
						$elm$html$Html$a,
						_List_fromArray(
							[
						...
						$elm$virtual_dom$VirtualDom$text(' to comment.')
					]));
		}
	});
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_Nil),
					$elm$virtual_dom$VirtualDom$text(' Delete Article')
				]));
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_Nil),
				$elm$virtual_dom$VirtualDom$text(' Edit Article')
			]));
};
...
var $author$project$Page$Article$favoriteButton = F2(
	function (cred, article) {
		...
		var kids = _List_fromArray(
			[
				$elm$virtual_dom$VirtualDom$text(
				' Favorite Article (' + (_String_fromNumber(favoritesCount) + ')'))
			]);
		return favorited ? A4(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_Nil),
					$elm$virtual_dom$VirtualDom$text(caption)
				]));
	});
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$virtual_dom$VirtualDom$text(timestamp)
								])),
							deleteCommentButton
						]))
				]));
...
var $elm$html$Html$Attributes$style = _VirtualDom_style;
var $author$project$Page$viewErrors = F2(
	function (dismissErrors, errors) {
		return $elm$core$List$isEmpty(errors) ? $elm$virtual_dom$VirtualDom$text('') : A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('error-messages'),
					A2($elm$virtual_dom$VirtualDom$style, 'position', 'fixed'),
					A2($elm$virtual_dom$VirtualDom$style, 'top', '0'),
					A2($elm$virtual_dom$VirtualDom$style, 'background', 'rgb(250, 250, 250)'),
					A2($elm$virtual_dom$VirtualDom$style, 'padding', '20px'),
					A2($elm$virtual_dom$VirtualDom$style, 'border', '1px solid')
				]),
			_Utils_ap(
				A2(
					$elm$core$List$map,
					function (error) {
						return A2(
							...
							_List_fromArray(
								[
									$elm$virtual_dom$VirtualDom$text(error)
								]));
					},
					errors),
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$virtual_dom$VirtualDom$text('Ok')
							]))
					])));
	});
...
var $author$project$Page$Article$view = function (model) {
	...
	switch (_v0.$) {
								...
								[
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$elm$virtual_dom$VirtualDom$text(title)
												])),
											A2(
											$elm$html$Html$div,
											_List_fromArray(
		...
		case 0:
			return {
				bt: $elm$virtual_dom$VirtualDom$text(''),
				bT: 'Article'
			};
		case 1:
								...
								[
									...
									_List_fromArray(
										[
											...
											A2($elm$virtual_dom$VirtualDom$attribute, 'rows', '8'),
...
var $author$project$Page$Article$Editor$viewProblem = function (problem) {
	...
	return A2(
		...
		_List_fromArray(
			[
				$elm$virtual_dom$VirtualDom$text(errorMessage)
			]));
};
		...
		var formHtml = function () {
			...
			switch (_v0.$) {
				...
				default:
					return _List_fromArray(
						[
							$elm$virtual_dom$VirtualDom$text('Article failed to load.')
						]);
			}
		}();
		return A2(
	...
	return {
		bt: function () {
			...
			if (!_v0.$) {
				...
				return $elm$virtual_dom$VirtualDom$text('Sign in to edit this article.');
			}
		}(),
		bT: function () {
			var _v1 = function (status) {
				switch (status.$) {
					case 0:
						var slug = status.a;
						return $elm$core$Maybe$Just(slug);
...
var $author$project$Article$Feed$viewTag = function (tagName) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$virtual_dom$VirtualDom$text(tagName)
			]));
};
			...
			if (!maybeCred.$) {
				...
				return A2(
					...
					_List_fromArray(
						[
							$elm$virtual_dom$VirtualDom$text(
							' ' + _String_fromNumber(favoritesCount))
						]));
			} else {
				return $elm$virtual_dom$VirtualDom$text('');
			}
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$virtual_dom$VirtualDom$text(description)
								])),
							A2(
							$elm$html$Html$span,
							_List_Nil,
							_List_fromArray(
								[
									$elm$virtual_dom$VirtualDom$text('Read more...')
								])),
							A2(
							$elm$html$Html$ul,
							_List_fromArray(
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$virtual_dom$VirtualDom$text('A place to share your knowledge.')
						]))
				]))
		]));
	...
	function (toMsg, page, _v0) {
		...
		return (totalPages > 1) ? A2(
			...
			A2(
				$elm$core$List$map,
				viewPageLink,
				A2($elm$core$List$range, 1, totalPages))) : $elm$virtual_dom$VirtualDom$text('');
	});
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$virtual_dom$VirtualDom$text(name)
						]))
				]));
	});
														...
														$elm$core$List$concat(
															_List_fromArray(
																[
																	...
																	A2(
																	$elm$core$List$map,
																	$elm$virtual_dom$VirtualDom$map($author$project$Page$Home$GotFeedMsg),
													...
													[
														...
														_List_fromArray(
															[
																...
																_List_fromArray(
																	[
																		$elm$virtual_dom$VirtualDom$text('Popular Tags')
																	])),
																function (tags) {
																return A2(
																	$elm$html$Html$div,
										...
										[
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															$elm$virtual_dom$VirtualDom$text('Need an account?')
														]))
												])),
											A2(
											$elm$html$Html$ul,
	...
	bt: A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$virtual_dom$VirtualDom$text('Not Found')
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$author$project$Asset$src(
								$author$project$Asset$image('error.jpg'))
							]),
						_List_Nil)
					]))
			])),
...
var $author$project$Page$Profile$titleForMe = F2(
	function (maybeCred, username) {
		if (!maybeCred.$) {
			...
			return _Utils_eq(
				username,
				$author$project$Api$username(cred)) ? 'My Profile' : 'Profile';
		} else {
			return 'Profile';
		}
	});
					...
					F2(
						function (maybeCred, username) {
							if (!maybeCred.$) {
								...
								return _Utils_eq(
									username,
									$author$project$Api$username(cred)) ? 'My Profile' : $author$project$Page$Profile$defaultTitle;
							} else {
																	...
																	$elm$core$List$concat(
																		_List_fromArray(
																			[
																				...
																				A2(
																				$elm$core$List$map,
																				$elm$virtual_dom$VirtualDom$map($author$project$Page$Profile$GotFeedMsg),
																				A2($author$project$Article$Feed$viewArticles, model.T, feed)),
																				_List_fromArray(
																				[
										...
										[
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															$elm$virtual_dom$VirtualDom$text('Have an account?')
														]))
												])),
											A2(
											$elm$html$Html$ul,
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$virtual_dom$VirtualDom$text('Update Settings')
								]))
						]))
				]));
	});
	...
	return {
		bt: function () {
			...
			if (!_v0.$) {
										...
										[
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															$elm$virtual_dom$VirtualDom$text('Your Settings')
														])),
													A2(
													$elm$html$Html$ul,
													_List_fromArray(
													...
													switch (_v1.$) {
														...
														case 1:
															return $author$project$Loading$icon;
														default:
															return $elm$virtual_dom$VirtualDom$text('Error loading page.');
													}
												}()
												]))
										]))
				...
				return $elm$virtual_dom$VirtualDom$text('Sign in to view your settings.');
			}
		}(),
		bT: 'Settings'
	};
	...
	var viewPage = F3(
		function (page, toMsg, config) {
			...
			return {
				X: A2(
					$elm$core$List$map,
					$elm$virtual_dom$VirtualDom$map(toMsg),
					body),
				bT: title
			};
		});
...
var $author$project$Main$main = A2(
	...
	$author$project$Viewer$decoder,
	{
		...
		aY: $author$project$Main$ChangedUrl,
		aZ: $author$project$Main$ClickedLink,
		be: function (model) {
			switch (model.$) {
				case 1:
					return $elm$core$Platform$Sub$none;
