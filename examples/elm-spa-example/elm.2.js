			...
			return A4(
				...
				A2(
					...
					$elm$core$Basics$floor(
						A2($elm$core$Basics$logBase, 32, treeLen - 1)) * $elm$core$Array$shiftStep),
				A2(
					$elm$core$Array$treeFromBuilder,
					reverseNodeList ? $elm$core$List$reverse(builder.i) : builder.i,
					builder.f),
				builder.h);
		}
	});
...
var $author$project$Api$Endpoint$url = F2(
	function (paths, queryParams) {
		return 'https://conduit.productionready.io' + ('/' + (A2(
			$elm$core$String$join,
			'/',
			A2(_List_cons, 'api', paths)) + $elm$url$Url$Builder$toQuery(queryParams)));
	});
	...
	if (dayInMonth < 0) {
		...
		var succeedWith = function (extraMs) {
			return $elm$parser$Parser$Advanced$succeed(
				(extraMs + (31536000000 * (year - 1970))) + (86400000 * ((((month < 3) || (!$rtfeldman$elm_iso8601_date_strings$Iso8601$isLeapYear(year))) ? (dayInMonth - 1) : dayInMonth) + ($rtfeldman$elm_iso8601_date_strings$Iso8601$leapYearsBefore(year) - $rtfeldman$elm_iso8601_date_strings$Iso8601$leapYearsBefore(1970)))));
		};
		switch (month) {
			case 1:
						...
						[
								...
								_List_fromArray(
									[
										...
										A2(
											...
											A2(
												$elm$parser$Parser$Advanced$keeper,
												$elm$parser$Parser$Advanced$succeed($rtfeldman$elm_iso8601_date_strings$Iso8601$utcOffsetMinutesFromParts),
												$elm$parser$Parser$Advanced$oneOf(
													_List_fromArray(
														[
															A2(
							...
							function (s) {
								return _Utils_eq(
									...
									$elm$parser$Parser$Advanced$Bad,
									false,
									A2($elm$parser$Parser$Advanced$fromState, s, $elm$parser$Parser$ExpectingEnd));
							})
						]));
			},
			A2(
	...
	if (!_v0.$) {
		...
		return $elm$core$Result$Err(
			A2(
				$elm$core$List$map,
				function (p) {
					return {aD: p.aD, a0: p.a0, a7: p.a7};
				},
				problems));
	}
};
var $rtfeldman$elm_iso8601_date_strings$Iso8601$decoder = A2(
	...
	function (str) {
		...
		if (_v0.$ === 1) {
			return $elm$json$Json$Decode$fail('TODO deadEndsToString');
		} else {
			var time = _v0.a;
...
var $author$project$PaginatedList$params = function (_v0) {
	...
	return _List_fromArray(
		[
			...
			$elm$url$Url$Builder$string,
			'offset',
			_String_fromNumber((page - 1) * resultsPerPage))
		]);
};
							...
							$author$project$Api$Endpoint$articles(
								A2(
									...
									$author$project$PaginatedList$params(
										{bL: page, bN: 5}))),
							maybeCred,
							A2($author$project$Article$Feed$decoder, maybeCred, 5))))));
	});
					...
					[
						...
						A2(
							...
							$elm$http$Http$toTask(
								A3(
									$author$project$Api$get,
									$author$project$Api$Endpoint$profiles(username),
									maybeCred,
									A2(
										$elm$json$Json$Decode$field,
										'profile',
...
var $author$project$Route$parser = function (state) {
	return A2(
		$elm$core$List$concatMap,
		function (_v0) {
			var parser = _v0;
			...
			function (value) {
				return toMsg(
					$elm$core$Result$toMaybe(
						A2(
							$elm$json$Json$Decode$decodeValue,
							$author$project$Api$storageDecoder(decoder),
							value)));
			});
	});
						...
						return _Utils_Tuple2(
							...
							A2(
								...
								function (cred) {
									return A4(
										$author$project$Api$post,
										$author$project$Api$Endpoint$comments(slug),
										$elm$core$Maybe$Just(cred),
								...
								A2(
									...
									_List_fromArray(
										[
											...
											$author$project$Article$Slug$toString(slug),
											'comments',
											$author$project$CommentId$toString(id)
										]),
									_List_Nil),
								cred,
								$elm$http$Http$Internal$EmptyBody,
						...
						_Utils_update(
							model,
							{
								e: A3(
									...
									{
										X: function () {
											var _v0 = $author$project$Article$body(article);
											var markdown = _v0;
											return markdown;
										}(),
										bw: description,
										...
										info,
										{
											aq: A2(
												...
												function (oldArticle) {
													return _Utils_eq(
														$author$project$Article$slug(article),
														$author$project$Article$slug(oldArticle)) ? article : oldArticle;
												},
												info.aq)
										});
								}()
							...
							function () {
								...
								return A4(
									...
									A2(
										$elm$json$Json$Decode$field,
										'user',
										$author$project$Api$decoderFromCred($author$project$Viewer$decoder)));
							}()));
				} else {
					var problems = _v1.a;
					return _Utils_Tuple2(
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							_VirtualDom_text('An interactive learning project from '),
							A2(
							$elm$html$Html$a,
							_List_fromArray(
								[
							...
							_List_fromArray(
								[
									_VirtualDom_text('Thinkster')
								])),
							_VirtualDom_text('. Code & design licensed under MIT.')
						]))
				]))
		]));
...
var $author$project$Username$toHtml = function (_v0) {
	var username = _v0;
	return _VirtualDom_text(username);
};
						...
						[
							...
							_List_fromArray(
								[
									...
									$author$project$Viewer$avatar(viewer))
								]),
							_List_Nil),
...
var $elm$time$Time$toCivil = function (minutes) {
	...
	return {
		...
		aW: month,
		bl: (yearOfEra + (era * 400)) + ((month <= 2) ? 1 : 0)
	};
};
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						A2(
							$author$project$Page$Article$ClickedPostComment,
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					'btn btn-sm ' + (A2($elm$core$String$join, ' ', extraClasses) + ' action-btn')),
...
var $author$project$Page$viewErrors = F2(
	function (dismissErrors, errors) {
		return $elm$core$List$isEmpty(errors) ? _VirtualDom_text('') : A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('error-messages'),
					A2(_VirtualDom_style, 'position', 'fixed'),
					A2(_VirtualDom_style, 'top', '0'),
					A2(_VirtualDom_style, 'background', 'rgb(250, 250, 250)'),
					A2(_VirtualDom_style, 'padding', '20px'),
					A2(_VirtualDom_style, 'border', '1px solid')
				]),
			_Utils_ap(
				A2(
					$elm$core$List$map,
									...
									function () {
										...
										switch (_v0.$) {
											...
											default:
												return _List_fromArray(
													[
														_VirtualDom_text('Article failed to load.')
													]);
										}
									}())
								]))
	...
	return {
		bt: function () {
			...
			if (!_v0.$) {
				...
				return _VirtualDom_text('Sign in to edit this article.');
			}
		}(),
		bT: function () {
			var _v1 = function () {
	...
	function (timeZone, _v0) {
		...
		return A2(
			...
			A2(
				$elm$core$List$map,
				A2(
					$author$project$Article$Feed$viewPreview,
					$author$project$Session$cred(session),
					timeZone),
				function () {
					var _v0 = articles;
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							_VirtualDom_text('A place to share your knowledge.')
						]))
				]))
		]));
							...
							[
								...
								_List_fromArray(
									[
										...
										_String_fromNumber(currentPage))
									]))
							]));
				},
				A2($elm$core$List$range, 1, totalPages))) : _VirtualDom_text('');
	});
														...
														$elm$core$List$concat(
															_List_fromArray(
																[
																	...
																	A2(
																	$elm$core$List$map,
																	_VirtualDom_map($author$project$Page$Home$GotFeedMsg),
										...
										[
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															_VirtualDom_text('Need an account?')
														]))
												])),
											A2(
											$elm$html$Html$ul,
													...
													[
														...
														_List_fromArray(
															[
																...
																_List_fromArray(
																	[
																		$author$project$Username$toHtml(
																		$author$project$Author$username(author))
																	])),
																A2(
																$elm$html$Html$p,
																	...
																	$elm$core$List$concat(
																		_List_fromArray(
																			[
																				...
																				A2(
																				$elm$core$List$map,
																				_VirtualDom_map($author$project$Page$Profile$GotFeedMsg),
																				A2($author$project$Article$Feed$viewArticles, model.T, feed)),
																				_List_fromArray(
																				[
										...
										[
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															_VirtualDom_text('Have an account?')
														]))
												])),
											A2(
											$elm$html$Html$ul,
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									_VirtualDom_text('Update Settings')
								]))
						]))
				]));
	});
	...
	return {
		bt: function () {
			...
			if (!_v0.$) {
										...
										[
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															_VirtualDom_text('Your Settings')
														])),
													A2(
													$elm$html$Html$ul,
													_List_fromArray(
													...
													switch (_v1.$) {
														...
														case 1:
															return $author$project$Loading$icon;
														default:
															return _VirtualDom_text('Error loading page.');
													}
												}()
												]))
										]))
				...
				return _VirtualDom_text('Sign in to view your settings.');
			}
		}(),
		bT: 'Settings'
	};
					...
					return A3(
						...
						$elm$core$Result$toMaybe(
							A2(
								...
								$elm$json$Json$Decode$decodeString(
									$author$project$Api$storageDecoder($author$project$Viewer$decoder)),
