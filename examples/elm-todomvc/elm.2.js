		...
		if (!builder.b) {
			...
			return A4(
				...
				A2(
					...
					reverseNodeList ? $elm$core$List$reverse(builder.e) : builder.e,
					builder.b),
				builder.d);
		}
	});
			...
			switch (msg.$) {
						...
						_Utils_update(
							model,
							{
								a: $elm$core$String$isEmpty(model.o) ? model.a : _Utils_ap(
									...
									_List_fromArray(
										[
											{h: false, v: model.o, C: false, f: model.z}
										])),
								o: '',
								z: model.z + 1
							}),
				...
				case 2:
					...
					return _Utils_Tuple2(
						...
						function () {
							var resultToMessage = function (_v1) {
...
var $author$project$Main$viewControlsClear = function (entriesCompleted) {
	return A2(
		...
		_List_fromArray(
			[
				_VirtualDom_text(
				'Clear completed (' + (_String_fromNumber(entriesCompleted) + ')'))
			]));
};
...
var $author$project$Main$viewControlsCount = function (entriesLeft) {
	return A2(
		...
		_List_fromArray(
			[
				A2(
				_VirtualDom_node('strong'),
				_List_Nil,
				_List_fromArray(
					[
						_VirtualDom_text(
						_String_fromNumber(entriesLeft))
					])),
				_VirtualDom_text(
				((entriesLeft === 1) ? ' item' : ' items') + ' left')
			]));
};
		...
		return A2(
			...
			_List_fromArray(
				[
					A2(
					_VirtualDom_lazy,
					$author$project$Main$viewControlsCount,
					$elm$core$List$length(entries) - entriesCompleted),
					A2(_VirtualDom_lazy, $author$project$Main$viewControlsFilters, visibility),
					A2(_VirtualDom_lazy, $author$project$Main$viewControlsClear, entriesCompleted)
				]));
	});
...
var $elm$html$Html$Keyed$node = function (tag) {
						...
						[
							...
							_List_fromArray(
								[
									...
									'todo-' + _String_fromNumber(todo.f)),
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_VirtualDom_style,
					'visibility',
					$elm$core$List$isEmpty(entries) ? 'hidden' : 'visible')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$stringProperty('htmlFor')('toggle-all')
						]),
					_List_fromArray(
						[
							_VirtualDom_text('Mark all as complete')
						])),
					A2(
					$elm$html$Html$Keyed$node('ul'),
					_List_fromArray(
						[
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$stringProperty('placeholder')('What needs to be done?'),
						$elm$html$Html$Attributes$boolProperty('autofocus')(true),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2(_VirtualDom_style, 'visibility', 'hidden')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						A2(_VirtualDom_lazy, $author$project$Main$viewInput, model.o),
						A3(_VirtualDom_lazy2, $author$project$Main$viewEntries, model.A, model.a),
						A3(_VirtualDom_lazy2, $author$project$Main$viewControls, model.A, model.a)
					])),
				A2(
				$elm$html$Html$footer,
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$virtual_dom$VirtualDom$text('Double-click to edit a todo')
							])),
						A2(
						$elm$html$Html$p,
						_List_Nil,
						_List_fromArray(
							[
								$elm$virtual_dom$VirtualDom$text('Written by '),
								A2(
								$elm$html$Html$a,
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										$elm$virtual_dom$VirtualDom$text('Evan Czaplicki')
									]))
							])),
						A2(
						$elm$html$Html$p,
						...
						_List_fromArray(
							[
								$elm$virtual_dom$VirtualDom$text('Part of '),
								A2(
								$elm$html$Html$a,
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										$elm$virtual_dom$VirtualDom$text('TodoMVC')
									]))
							]))
					]))
			]));
...
var $author$project$Main$main = _Browser_document(
	{
		aB: function (maybeModel) {
			return _Utils_Tuple2(
				A2(
					$elm$core$Maybe$withDefault,
					{a: _List_Nil, o: '', z: 0, A: 'All'},
					maybeModel),
				$elm$core$Platform$Cmd$none);
		},
		aH: function (_v0) {
