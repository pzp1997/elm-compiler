...
var $author$project$Main$abs = function (n) {
	return (n < 0) ? (-n) : n;
};
var $author$project$Main$formatAnswer = function (ans) {
	return 'The answer is ' + ($elm$core$String$fromInt(ans) + '!');
};
var $elm$virtual_dom$VirtualDom$text = _VirtualDom_text;
var $elm$html$Html$text = $elm$virtual_dom$VirtualDom$text;
var $author$project$Main$main = $elm$html$Html$text(
	$author$project$Main$formatAnswer(
		$author$project$Main$abs(-2)));
